...
package com.baidu.carlife.sdk.internal.opengl.grafika;
...
public class Drawable2d {
     ...
     */
    private static final float[] TRIANGLE_COORDS = new float[] {
         0.0f,  0.577350269f,   // 0 top
        -0.5f, -0.288675135f,   // 1 bottom left
         0.5f, -0.288675135f    // 2 bottom right
    };
    private static final float[] TRIANGLE_TEX_COORDS = new float[] {
     ...
     */
    private static final float[] RECTANGLE_COORDS =  new float[] {
        -0.5f, -0.5f,   // 0 bottom left
         0.5f, -0.5f,   // 1 bottom right
        -0.5f,  0.5f,   // 2 top left
         0.5f,  0.5f,   // 3 top right
    };
    private static final float[] RECTANGLE_TEX_COORDS =  new float[] {
     ...
     */
    private static final float[] FULL_RECTANGLE_COORDS =  new float[] {
        -1.0f, -1.0f,   // 0 bottom left
         1.0f, -1.0f,   // 1 bottom right
        -1.0f,  1.0f,   // 2 top left
         1.0f,  1.0f,   // 3 top right
    };
    private static final float[] FULL_RECTANGLE_TEX_COORDS =  new float[] {
