...
public class GeneratedTexture {
     ...
     */
    private static final ByteBuffer S_COARSE_IMAGE_DATA = generateCoarseData();
    private static final ByteBuffer S_FINE_IMAGE_DATA = generateFineData();
    ...
    public static int createTestTexture(Image which) {
        ...
        switch (which) {
            case COARSE:
                buf = S_COARSE_IMAGE_DATA;
                break;
            case FINE:
                buf = S_FINE_IMAGE_DATA;
                break;
            default:
