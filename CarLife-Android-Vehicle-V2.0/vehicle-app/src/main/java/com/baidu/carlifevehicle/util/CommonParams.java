...
public class CommonParams {
    ...
    public static final int MSG_CONNECT_STATUS_ESTABLISHED = 1019;
    public static final int MSG_CONNECT_FAIL_AUTHEN_FAILED = 1020;
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                try {
                    ...
                    // Logger.d("GetMsgName", "get msg name fail: i = " + i);
                }
                // }
            }
        } catch (Exception excep) {
            Logger.d("GetMsgName", "get msg name fail");
        }
