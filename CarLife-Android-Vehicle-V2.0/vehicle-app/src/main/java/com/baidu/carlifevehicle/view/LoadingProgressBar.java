...
public class LoadingProgressBar extends RelativeLayout {
    ...
    public void loadFinished() {
        ...
        animSet3.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                logoNameAnimSet.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator arg0) {
                        ...
                        if (!cancel) {
                            Logger.d(TAG, "check cancel=false");
                            stopAnimation();
                        } else {
                            Logger.d(TAG, "check cancel=ture");
                            cancel = false;
                        }
                        ...
                        try {
                            if ((CarLife.receiver().getConnectionType() == CarLifeContext.CONNECTION_TYPE_AOA)
                                    && CarLife.receiver().isConnected()) {
                                String hintResStr =
                            ...
                            Logger.d(TAG, "aoa connection get exception");
                            ex.printStackTrace();
                        }
                    }
    ...
    public void stopAnimation() {
        ...
        if (windMillRotation != null) {
            Logger.d(TAG, "windMillRotation.cancel()");
